...
int main (int argc, char *argv[]) {
    ...
    auto kgraph_file      = R"(c:/Data/Feature/SIFT1M/kgraph/K90 It12 S20 R50 L130 recall0.993.kg)";
    ...
    params.S = kgraph::default_S; // Use default.
   ...
   if (params.P < params.K) 
    ...
    std::vector<unsigned> P_search_parameter = { 10, 50, 100, 200, 300, 500 };
